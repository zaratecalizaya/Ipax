												...
												<div class="form-body">
													<form class="row g-3">
														...
														<div class="col-sm-6">
															...
															<input type="text" class="form-control" id="apellidos" name="apellidos" placeholder="Deo">
														</div>
														...
														<div class="col-12">
															<label for="inputSelectCountry" class="form-label">Genero</label>
															<select class="form-select" id="genero" nombre="genero" aria-label="Default select example">
