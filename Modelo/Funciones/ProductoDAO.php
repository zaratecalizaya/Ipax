...
class ProductoDAO {
    ...
    public function listProductoseguncategoria($datos){
      ...
      $query = "SELECT  p.id,p.Nombre,i.Nombre as imagen ,p.Precio, c.Nombre as categoria FROM Producto as p inner join Categoria as c on c.id=p.idCategoria inner join Imagen as  i on p.idImagen=i.id where p.idCategoria='".$categoria."'";
